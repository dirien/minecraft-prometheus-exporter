...
This document outlines security procedures and general policies for the `minecraft-prometheus-exporter`
project.
...
The `minecraft-prometheus-exporter` team and community take all security bugs in `minecraft-prometheus-exporter`
seriously. Thank you for improving the security of `minecraft-prometheus-exporter`. We appreciate your efforts and
